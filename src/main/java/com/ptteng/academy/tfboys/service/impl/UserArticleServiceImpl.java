...
return result;	
	...
	public Long  getUserArticleIdByArticleIDAndUserID(Long articleID,Long userID)throws ServiceException, ServiceDaoException{
		      ...
		      if(log.isInfoEnabled()){
	  log.info(" get id by articleID,userID  : " + articleID+" , "+userID );
	  }
	  Long id = null;
	...
	try {
        ...
        id = (Long) dao.getMapping("getUserArticleIdByArticleIDAndUserID", new Object[] {articleID,userID });
   } catch (DaoException e) {
			log.error(" get id wrong by articleID,userID  : " + articleID+" , "+userID );
			log.error(e);
			e.printStackTrace();
			throw new ServiceDaoException(e);
		}
  if(log.isInfoEnabled()){
   log.info(" get id success : " + id);
	...
	try {
		idList = dao.getIdList("getUserArticleIdsByCollectionStatusAndUserID", new Object[] { collectionStatus,userID},start,limit, false);
  ...
  if(log.isInfoEnabled()){
   log.info(" get ids success : " + (idList == null ? "null" : idList.size()));
	...
	try {
		idList = dao.getIdList("getUserArticleIdsByLikedStatusAndUserID", new Object[] { likedStatus,userID},start,limit, false);
  ...
  if(log.isInfoEnabled()){
   log.info(" get ids success : " + (idList == null ? "null" : idList.size()));
	...
	try {
		...
		count = dao.count("getUserArticleIdsByCollectionStatusAndUserID", new Object[] { collectionStatus,userID});
  ...
  if(log.isInfoEnabled()){
	...
	try {
		...
		count = dao.count("getUserArticleIdsByLikedStatusAndUserID", new Object[] { likedStatus,userID});
