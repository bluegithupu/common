...
<%@ include file="../../../includes/includes.jsp"%>
	...
	<div id="roleDetailApp" ng-app="roleDetailApp">
		<div ng-controller="roleDetailController">
			...
			<div class="portlet">
			    ...
			    <form class="form-horizontal" role="form" name="roleForm">
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="roleName" ng-model="role.roleName" ng-bind="role.roleName" placeholder="请输入角色名" required>
			        </div>
			        </div>
	 ...
	 <script src="/r/js-src/web/academy-tfboys-service/role/roleDetail.js"></script>
